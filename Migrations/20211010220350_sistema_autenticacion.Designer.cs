...
namespace SurveyWS.Migrations
{
    ...
    [Migration("20211010220350_sistema_autenticacion")]
    partial class sistema_autenticacion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyWS.Infrastructure.EntityFramework.Entities.SurveyDetailEf", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long?>("survey_template_detail_id")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("survey_template_detail_id");

                    b.ToTable("survey_detail");
                });

            modelBuilder.Entity("SurveyWS.Infrastructure.EntityFramework.Entities.SurveyEf", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SurveyWS.Infrastructure.EntityFramework.Entities.SurveyDetailEf", b =>
                {
                    b.HasOne("SurveyWS.Infrastructure.EntityFramework.Entities.SurveyEf", "Survey")
                        .WithMany()
                        .HasForeignKey("survey_id");

                    b.HasOne("SurveyWS.Infrastructure.EntityFramework.Entities.SurveyTemplateDetailEf", "SurveyTemplateDetail")
                        .WithMany()
                        .HasForeignKey("survey_template_detail_id");

                    b.Navigation("Survey");

                    b.Navigation("SurveyTemplateDetail");
                });
